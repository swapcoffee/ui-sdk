<template>
  <div class="distribution" @click="showMore">
    <div class="distribution__group">
      <div class="distribution__plan">
        <svg class="distribution__icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      <p class="distribution__desc">{{ $t('dexDistribution.plan', {dexNames: getDexNames}) }}</p>
    </div>
    <svg class="distribution__arrow-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
      <g opacity="0.5">
